// lib/checklist/add_category_screen.dart
...
class _AddCategoryScreenState extends State<AddCategoryScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(_editingCategory == null ? 'Categoria adicionada com sucesso!' : 'Categoria atualizada com sucesso!'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_editingCategory == null ? 'Nova Categoria' : 'Editar Categoria'),
